...
public class PriceAction {
    ...
    private static final Logger logger = LogManager.getLogger(PriceAction.class);


    public HashMap buildPriceAction(HashMap stockDetailsMap, int length, HighLowPoint point) {
