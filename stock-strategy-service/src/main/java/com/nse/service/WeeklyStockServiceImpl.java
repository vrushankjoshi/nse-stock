...
public class WeeklyStockServiceImpl implements WeeklyStockService {
    ...
    public void createWeeklyStocks(String stockSymbol) {
        ...
        if (lastProcessingDay == null  ) {
            ...
            if (startDate == null)
                startDate = DateUtils.addDays(endDate,-20);
        }
        ...
        stockRepositoryImpl.saveAllEntities(weeklyStockListResponse);
        logger.info("[WeeklyStockServiceImpl] - createWeeklyStocks() :: stockRepositoryImpl.saveAllEntities(weeklyStockListResponse) " );
        lastProcessingDay.setWeekProcessingDay(DateUtils.addDays(endDate,-1));
